...
urlpatterns = [
    ...
    path('friends/<int:pk>/', cache_page(60 * 15) (ViewFriendLinkDetail.as_view()), name='friend'),
    path('persons/', ViewPersons.as_view(), name='persons'),
    path('persona/<int:pk>/', cache_page(60 * 15) (ShowPersona.as_view()), name='persona'),
    ...
    path('book/<int:book_category_id>/', get_book_category, name='get_book_category'),
    path('category/<int:category_id>/', get_category, name='get_post_category'),
    path('post/<int:pk>/', cache_page(60 * 15) (ShowPost.as_view()), name='view_post'),
    ...
    path('gallery/<int:pk>/', cache_page(60 * 15) (ShowImageGallery.as_view()), name='image_gallery'),
    path('calendar/', view_calendar, name='month_event_calendar'),
    path('suvorov/', cache_page(60 * 15) (view_suvorov), name='suvorov'),
